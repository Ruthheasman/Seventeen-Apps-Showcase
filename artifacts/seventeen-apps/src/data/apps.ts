/**
 * The seventeen apps, exactly as supplied. Names, descriptions and URLs are
...
export interface ShowcaseApp {
  ...
  description: string;
  url: string;
  /** Path under `public/`, e.g. `apps/1satchel.jpg`. */
  image: string;
}
...
export const apps: ShowcaseApp[] = [
  ...
  },
  {
    ...
    image: 'apps/bsv-patent-forge.jpg',
  },
  {
    number: 6,
    name: 'Wonkerly',
  ...
  },
  {
    ...
    image: 'apps/number-cruncher-3d.png',
  },
  {
    number: 12,
    ...
    image: 'apps/ai-bitcoin-revolution.png',
  },
  {
    number: 13,
  ...
  },
  {
    ...
    image: 'apps/quiz-battle-live.png',
  },
];
